...
Communication	Wi-Fi AP direct connection (default SSID ESP32_GestureControl)
Quickstart
...
Ensure OpenCV, MediaPipe, and requests are installed (pip install opencv-python mediapipe requests).
